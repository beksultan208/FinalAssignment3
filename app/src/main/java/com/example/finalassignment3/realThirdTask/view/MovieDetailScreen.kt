...
package com.example.finalassignment3.realThirdTask.view
...
fun MovieCollectionRow(
    ...
    Column (){
        Row (modifier = Modifier.padding(26.dp).height(20.dp).fillMaxWidth(), horizontalArrangement = Arrangement.Absolute.SpaceBetween){
